...
// #endif
    ...
    for(i = 0; i < MLX90640_COLUMN_NUM; i++)
    {
        if (accColumn[i] > 7)
        {
...
// #endif
    for(i = 0; i < MLX90640_LINE_NUM; i++)
    {
        for(j = 0; j < MLX90640_COLUMN_NUM; j ++)
        {
            p = 32 * i +j;
...
// #endif
    temp = alphaTemp[0];
    for(i = 1; i < MLX90640_PIXEL_NUM; i++)
    {
        if (alphaTemp[i] > temp)
        {
            temp = alphaTemp[i];
...
// #endif
    ...
    for(i = 0; i < MLX90640_PIXEL_NUM; i++)
    {
